...
Because of this, the request cannot be assumed buildable as literal physical relocation. The plan is **probe-first**: a cheap in-game measurement decides what the feature can be, *before* any population-write code is written. Two parts are separable:
...
## Phase 0 — The feasibility probe (MANDATORY FIRST; blocks all write code)
