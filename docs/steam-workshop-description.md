...
[*][b]Displacement.[/b] Combat damage, pillaging, sieges, starvation, unrest, and disasters produce refugees. People fleeing a crisis prefer another settlement of their own civilization and only cross a border when their homeland has nothing to offer, which is how displacement mostly works. The "Movement between civilizations" slider spans from that settled behavior up to free movement.
...
[*][b]Attribution.[/b] Each move records its deciding factor (prosperity, distance, safety, open borders, allies, asylum, crisis, or war), surfaced in notifications, city readouts, warnings, crisis reports, and a persistent log.
...
Creating [i]Emigration[/i] included a donation to the International Refugee Assistance Project. I cannot sustain a per-subscriber pledge, but plan to mark major milestones with donations of time or money. Please consider supporting UNHCR, the IRC, Médecins Sans Frontières (MSF), IRAP, or local refugee and mutual-aid groups.
