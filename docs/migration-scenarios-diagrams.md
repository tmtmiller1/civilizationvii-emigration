...
[cultural-enclaves.md](../../../mod_ideas_tested/_archived-emigration-enclave-feature/docs/cultural-enclaves.md) (archived). Note there are two distinct "quarter" systems:
