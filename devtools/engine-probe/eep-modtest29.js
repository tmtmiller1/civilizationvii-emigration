// eep-modtest29.js - how the mod's three decision pop-ups actually render (user: "bootleg": weird spacing,
...
function parts(d) {
  ...
  const body = d.querySelector("[role='paragraph']");
...
async function run() {
  ...
  emit("DONE modtest29 finished");
}

emit("modtest29 attached");
let beginTries = 0;
