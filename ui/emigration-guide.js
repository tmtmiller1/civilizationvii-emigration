...
const GUIDE = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What is the Migration Chronicle?", a: "A written history of the world's great migrations, recorded as it happens. As large waves move, it captures the moments worth keeping, a city emptied by war or disaster, a diaspora taking root far from home, a people returning once their homeland recovered, each as a short line of prose. These appear in the Notifications tab as \"Chronicle\" entries, alongside the per-event detail, so the whole story lives in one place." },
